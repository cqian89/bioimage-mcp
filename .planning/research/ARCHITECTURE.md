...
│  └─ IntrospectionEngine                                       │
 ...
 |-----------|----------------|------------------------|
 | IntrospectionEngine | Orchestrates AST-first + runtime fallback, merges overlays, emits params_schema. | Python module in `registry/`. |
 ...
 **Example:**
 ...
 tools/describe
     ↓
 DiscoveryService → IntrospectionEngine → SchemaCache/RegistryIndex
     ↓                         ↓
